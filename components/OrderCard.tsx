      ...
      <Card className="mt-[16px] rounded-[6px]">
        <View className="p-[10px] flex-row justify-between">
          ...
          <View className="flex justify-center items-center flex-col">
            <Text className="text-gray-600 text-[12px]">{item.carrier}-{item.trackingId}</Text>
            <Text className="text-gray-600 text-[16px]">{item.trackingItems.customer.name}</Text>
          </View>

          <View className="flex flex-row justify-center items-center">
            <Text className="text-[#EB6A7C]">{item.trackingItems.items.length} x </Text>
